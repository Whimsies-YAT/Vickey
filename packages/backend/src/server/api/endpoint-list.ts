...
export * as 'admin/abuse-report/auto-processed/export' from './endpoints/admin/abuse-report/auto-processed/export.js';
export * as 'admin/abuse-report/auto-processed/show' from './endpoints/admin/abuse-report/auto-processed/show.js';
...
export * as 'admin/avatar-decorations/import-zip' from './endpoints/admin/avatar-decorations/import-zip.js';
...
export * as 'admin/email/templates/show' from './endpoints/admin/email/templates/show.js';
export * as 'admin/email/templates/update' from './endpoints/admin/email/templates/update.js';
...
export * as 'admin/graceful-reload' from './endpoints/admin/graceful-reload.js';
...
export * as 'admin/logs/clear' from './endpoints/admin/logs/clear.js';
export * as 'admin/logs/config' from './endpoints/admin/logs/config.js';
export * as 'admin/logs/show' from './endpoints/admin/logs/show.js';
...
export * as 'admin/payments/show' from './endpoints/admin/payments/show.js';
export * as 'admin/payments/stats' from './endpoints/admin/payments/stats.js';
...
export * as 'admin/show-pending' from './endpoints/admin/show-pending.js';
export * as 'admin/show-pendings' from './endpoints/admin/show-pendings.js';
...
export * as 'admin/users/get-risk-score' from './endpoints/admin/users/get-risk-score.js';
export * as 'admin/users/list-high-risk-users' from './endpoints/admin/users/list-high-risk-users.js';
export * as 'admin/users/list-risk-events' from './endpoints/admin/users/list-risk-events.js';
export * as 'admin/users/manage-account-links' from './endpoints/admin/users/manage-account-links.js';
export * as 'admin/users/risk-score' from './endpoints/admin/users/risk-score.js';
...
export * as 'export-custom-avatar-decoration' from './endpoints/export-custom-avatar-decoration.js';
...
export * as 'following/requests/display' from './endpoints/following/requests/display.js';
export * as 'following/requests/ignore' from './endpoints/following/requests/ignore.js';
...
export * as 'gomoku/cancel-match' from './endpoints/gomoku/cancel-match.js';
export * as 'gomoku/games' from './endpoints/gomoku/games.js';
export * as 'gomoku/invitations' from './endpoints/gomoku/invitations.js';
export * as 'gomoku/match' from './endpoints/gomoku/match.js';
export * as 'gomoku/show-game' from './endpoints/gomoku/show-game.js';
export * as 'gomoku/surrender' from './endpoints/gomoku/surrender.js';
...
export * as 'i/authorized-sso' from './endpoints/i/authorized-sso.js';
...
export * as 'i/delete-all-sessions' from './endpoints/i/delete-all-sessions.js';
export * as 'i/delete-session' from './endpoints/i/delete-session.js';
export * as 'i/disconnect-sso' from './endpoints/i/disconnect-sso.js';
...
export * as 'i/update-timeline-preferences' from './endpoints/i/update-timeline-preferences.js';
...
export * as 'notes/interaction' from './endpoints/notes/interaction.js';
...
export * as 'notes/smart-timeline' from './endpoints/notes/smart-timeline.js';
...
export * as 'notes/timeline-refresh' from './endpoints/notes/timeline-refresh.js';
export * as 'notes/timeline-stats' from './endpoints/notes/timeline-stats.js';
export * as 'notes/translate' from './endpoints/notes/translate.js';
export * as 'notes/tts' from './endpoints/notes/tts.js';
...
export * as 'payment/cancel-subscription' from './endpoints/payment/cancel-subscription.js';
export * as 'payment/confirm-intent' from './endpoints/payment/confirm-intent.js';
export * as 'payment/create-intent' from './endpoints/payment/create-intent.js';
export * as 'payment/create-subscription' from './endpoints/payment/create-subscription.js';
export * as 'payment/get-config' from './endpoints/payment/get-config.js';
...
export * as 'sso/providers' from './endpoints/sso/providers.js';
...
export * as 'werewolf/action' from './endpoints/werewolf/action.js';
export * as 'werewolf/create' from './endpoints/werewolf/create.js';
export * as 'werewolf/finish-testament' from './endpoints/werewolf/finish-testament.js';
export * as 'werewolf/game-history' from './endpoints/werewolf/game-history.js';
export * as 'werewolf/games' from './endpoints/werewolf/games.js';
export * as 'werewolf/get-voice-creds' from './endpoints/werewolf/get-voice-creds.js';
export * as 'werewolf/join' from './endpoints/werewolf/join.js';
export * as 'werewolf/leave' from './endpoints/werewolf/leave.js';
export * as 'werewolf/ready' from './endpoints/werewolf/ready.js';
export * as 'werewolf/self-destruct' from './endpoints/werewolf/self-destruct.js';
export * as 'werewolf/send-message' from './endpoints/werewolf/send-message.js';
export * as 'werewolf/show' from './endpoints/werewolf/show.js';
export * as 'werewolf/skip-speech' from './endpoints/werewolf/skip-speech.js';
export * as 'werewolf/take-seat' from './endpoints/werewolf/take-seat.js';
export * as 'werewolf/unready' from './endpoints/werewolf/unready.js';
export * as 'werewolf/voice-negotiate' from './endpoints/werewolf/voice-negotiate.js';
export * as 'werewolf/voice-pull-single-track' from './endpoints/werewolf/voice-pull-single-track.js';
export * as 'werewolf/voice-pull-tracks' from './endpoints/werewolf/voice-pull-tracks.js';
