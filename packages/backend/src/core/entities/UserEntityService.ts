...
export class UserEntityService implements OnModuleInit {
	...
	public async pack<S extends 'MeDetailed' | 'UserDetailedNotMe' | 'UserDetailed' | 'UserLite' = 'UserLite'>(
		...
		const packed = {
			...
			host: user.host,
			// avatarUrl: user.avatarId == null ? this.getIdenticonUrl(user) : (user.avatarUrl ? (user.host == null ? user.avatarUrl : this.driveFileEntityService.getProxiedUrl(user.avatarUrl, 'avatar')) : this.getIdenticonUrl(user)),
			avatarUrl: user.avatarId == null ? this.getIdenticonUrl(user) : (user.avatarUrl ? this.driveFileEntityService.getProxiedUrl(user.avatarUrl, 'avatar') : this.getIdenticonUrl(user)),
			...
			...(isDetailed ? {
				...
				// bannerUrl: user.bannerId == null ? null : (user.bannerUrl ? (user.host === null ? user.bannerUrl : this.driveFileEntityService.getProxiedUrl(user.bannerUrl)) : null),
				bannerUrl: user.bannerId == null ? null : (user.bannerUrl ? this.driveFileEntityService.getProxiedUrl(user.bannerUrl) : null),
			...
			...(isDetailed && (isMe || iAmModerator) ? {
				...
				isPasswordSet: profile!.password != null,
