...
export type AdminAbuseReportAutoProcessedExportRequest = operations['admin___abuse-report___auto-processed___export']['requestBody']['content']['application/json'];
export type AdminAbuseReportAutoProcessedShowRequest = operations['admin___abuse-report___auto-processed___show']['requestBody']['content']['application/json'];
...
export type AdminAvatarDecorationsImportZipRequest = operations['admin___avatar-decorations___import-zip']['requestBody']['content']['application/json'];
...
export type AdminEmailTemplatesShowRequest = operations['admin___email___templates___show']['requestBody']['content']['application/json'];
export type AdminEmailTemplatesUpdateRequest = operations['admin___email___templates___update']['requestBody']['content']['application/json'];
...
export type AdminLogsClearResponse = operations['admin___logs___clear']['responses']['200']['content']['application/json'];
export type AdminLogsConfigRequest = operations['admin___logs___config']['requestBody']['content']['application/json'];
export type AdminLogsConfigResponse = operations['admin___logs___config']['responses']['200']['content']['application/json'];
export type AdminLogsShowRequest = operations['admin___logs___show']['requestBody']['content']['application/json'];
export type AdminLogsShowResponse = operations['admin___logs___show']['responses']['200']['content']['application/json'];
export type AdminMetaResponse = operations['admin___meta']['responses']['200']['content']['application/json'];
export type AdminNotesListDeletedRequest = operations['admin___notes___list-deleted']['requestBody']['content']['application/json'];
export type AdminNotesListDeletedResponse = operations['admin___notes___list-deleted']['responses']['200']['content']['application/json'];
export type AdminNotesShowDeletedRequest = operations['admin___notes___show-deleted']['requestBody']['content']['application/json'];
export type AdminNotesShowDeletedResponse = operations['admin___notes___show-deleted']['responses']['200']['content']['application/json'];
export type AdminOauthClientConfigCreateRequest = operations['admin___oauth-client-config___create']['requestBody']['content']['application/json'];
export type AdminOauthClientConfigCreateResponse = operations['admin___oauth-client-config___create']['responses']['200']['content']['application/json'];
export type AdminOauthClientConfigDeleteRequest = operations['admin___oauth-client-config___delete']['requestBody']['content']['application/json'];
export type AdminOauthClientConfigDeleteResponse = operations['admin___oauth-client-config___delete']['responses']['200']['content']['application/json'];
export type AdminOauthClientConfigDiscoverRequest = operations['admin___oauth-client-config___discover']['requestBody']['content']['application/json'];
export type AdminOauthClientConfigDiscoverResponse = operations['admin___oauth-client-config___discover']['responses']['200']['content']['application/json'];
export type AdminOauthClientConfigListResponse = operations['admin___oauth-client-config___list']['responses']['200']['content']['application/json'];
export type AdminOauthClientConfigUpdateRequest = operations['admin___oauth-client-config___update']['requestBody']['content']['application/json'];
export type AdminOauthClientConfigUpdateResponse = operations['admin___oauth-client-config___update']['responses']['200']['content']['application/json'];
export type AdminPaymentsListRequest = operations['admin___payments___list']['requestBody']['content']['application/json'];
export type AdminPaymentsListResponse = operations['admin___payments___list']['responses']['200']['content']['application/json'];
export type AdminPaymentsShowRequest = operations['admin___payments___show']['requestBody']['content']['application/json'];
export type AdminPaymentsShowResponse = operations['admin___payments___show']['responses']['200']['content']['application/json'];
export type AdminPaymentsStatsRequest = operations['admin___payments___stats']['requestBody']['content']['application/json'];
export type AdminPaymentsStatsResponse = operations['admin___payments___stats']['responses']['200']['content']['application/json'];
...
export type AdminRecommendationStatsRequest = operations['admin___recommendation-stats']['requestBody']['content']['application/json'];
export type AdminRecommendationStatsResponse = operations['admin___recommendation-stats']['responses']['200']['content']['application/json'];
...
export type AdminRemoveKeysRequest = operations['admin___remove-keys']['requestBody']['content']['application/json'];
...
export type AdminShowPendingRequest = operations['admin___show-pending']['requestBody']['content']['application/json'];
export type AdminShowPendingResponse = operations['admin___show-pending']['responses']['200']['content']['application/json'];
export type AdminShowPendingsRequest = operations['admin___show-pendings']['requestBody']['content']['application/json'];
export type AdminShowPendingsResponse = operations['admin___show-pendings']['responses']['200']['content']['application/json'];
...
export type AdminUnregister2faRequest = operations['admin___unregister-2fa']['requestBody']['content']['application/json'];
...
export type AdminUsersGetRiskScoreRequest = operations['admin___users___get-risk-score']['requestBody']['content']['application/json'];
export type AdminUsersGetRiskScoreResponse = operations['admin___users___get-risk-score']['responses']['200']['content']['application/json'];
export type AdminUsersListHighRiskUsersRequest = operations['admin___users___list-high-risk-users']['requestBody']['content']['application/json'];
export type AdminUsersListHighRiskUsersResponse = operations['admin___users___list-high-risk-users']['responses']['200']['content']['application/json'];
export type AdminUsersListRiskEventsRequest = operations['admin___users___list-risk-events']['requestBody']['content']['application/json'];
export type AdminUsersListRiskEventsResponse = operations['admin___users___list-risk-events']['responses']['200']['content']['application/json'];
export type AdminUsersManageAccountLinksRequest = operations['admin___users___manage-account-links']['requestBody']['content']['application/json'];
export type AdminUsersRiskScoreRequest = operations['admin___users___risk-score']['requestBody']['content']['application/json'];
export type AdminUsersRiskScoreResponse = operations['admin___users___risk-score']['responses']['200']['content']['application/json'];
...
export type AppDeleteRequest = operations['app___delete']['requestBody']['content']['application/json'];
...
export type AppUpdateRequest = operations['app___update']['requestBody']['content']['application/json'];
export type AppUpdateResponse = operations['app___update']['responses']['200']['content']['application/json'];
...
export type GomokuCancelMatchRequest = operations['gomoku___cancel-match']['requestBody']['content']['application/json'];
export type GomokuGamesRequest = operations['gomoku___games']['requestBody']['content']['application/json'];
export type GomokuGamesResponse = operations['gomoku___games']['responses']['200']['content']['application/json'];
export type GomokuInvitationsResponse = operations['gomoku___invitations']['responses']['200']['content']['application/json'];
export type GomokuMatchRequest = operations['gomoku___match']['requestBody']['content']['application/json'];
export type GomokuMatchResponse = operations['gomoku___match']['responses']['200']['content']['application/json'];
export type GomokuShowGameRequest = operations['gomoku___show-game']['requestBody']['content']['application/json'];
export type GomokuShowGameResponse = operations['gomoku___show-game']['responses']['200']['content']['application/json'];
export type GomokuSurrenderRequest = operations['gomoku___surrender']['requestBody']['content']['application/json'];
...
export type IAuthorizedSsoResponse = operations['i___authorized-sso']['responses']['200']['content']['application/json'];
...
export type IDeleteAllSessionsRequest = operations['i___delete-all-sessions']['requestBody']['content']['application/json'];
export type IDeleteSessionRequest = operations['i___delete-session']['requestBody']['content']['application/json'];
export type IDisconnectSsoRequest = operations['i___disconnect-sso']['requestBody']['content']['application/json'];
export type IDisconnectSsoResponse = operations['i___disconnect-sso']['responses']['200']['content']['application/json'];
...
export type IUpdateTimelinePreferencesRequest = operations['i___update-timeline-preferences']['requestBody']['content']['application/json'];
export type IUpdateTimelinePreferencesResponse = operations['i___update-timeline-preferences']['responses']['200']['content']['application/json'];
...
export type NotesInteractionRequest = operations['notes___interaction']['requestBody']['content']['application/json'];
export type NotesInteractionResponse = operations['notes___interaction']['responses']['200']['content']['application/json'];
...
export type NotesSmartTimelineRequest = operations['notes___smart-timeline']['requestBody']['content']['application/json'];
export type NotesSmartTimelineResponse = operations['notes___smart-timeline']['responses']['200']['content']['application/json'];
...
export type NotesTimelineRefreshResponse = operations['notes___timeline-refresh']['responses']['200']['content']['application/json'];
export type NotesTimelineStatsResponse = operations['notes___timeline-stats']['responses']['200']['content']['application/json'];
...
export type OauthAppsCreateRequest = operations['oauth-apps___create']['requestBody']['content']['application/json'];
export type OauthAppsCreateResponse = operations['oauth-apps___create']['responses']['200']['content']['application/json'];
export type OauthAppsDeleteRequest = operations['oauth-apps___delete']['requestBody']['content']['application/json'];
export type OauthAppsListResponse = operations['oauth-apps___list']['responses']['200']['content']['application/json'];
export type OauthAppsUpdateRequest = operations['oauth-apps___update']['requestBody']['content']['application/json'];
export type OauthAppsUpdateResponse = operations['oauth-apps___update']['responses']['200']['content']['application/json'];
...
export type PaymentCancelSubscriptionRequest = operations['payment___cancel-subscription']['requestBody']['content']['application/json'];
export type PaymentCancelSubscriptionResponse = operations['payment___cancel-subscription']['responses']['200']['content']['application/json'];
export type PaymentConfirmIntentRequest = operations['payment___confirm-intent']['requestBody']['content']['application/json'];
export type PaymentConfirmIntentResponse = operations['payment___confirm-intent']['responses']['200']['content']['application/json'];
export type PaymentCreateIntentRequest = operations['payment___create-intent']['requestBody']['content']['application/json'];
export type PaymentCreateIntentResponse = operations['payment___create-intent']['responses']['200']['content']['application/json'];
export type PaymentCreateSubscriptionRequest = operations['payment___create-subscription']['requestBody']['content']['application/json'];
export type PaymentCreateSubscriptionResponse = operations['payment___create-subscription']['responses']['200']['content']['application/json'];
export type PaymentGetConfigResponse = operations['payment___get-config']['responses']['200']['content']['application/json'];
...
export type SsoProvidersResponse = operations['sso___providers']['responses']['200']['content']['application/json'];
...
export type WerewolfActionRequest = operations['werewolf___action']['requestBody']['content']['application/json'];
export type WerewolfCreateRequest = operations['werewolf___create']['requestBody']['content']['application/json'];
export type WerewolfCreateResponse = operations['werewolf___create']['responses']['200']['content']['application/json'];
export type WerewolfFinishTestamentRequest = operations['werewolf___finish-testament']['requestBody']['content']['application/json'];
export type WerewolfGameHistoryRequest = operations['werewolf___game-history']['requestBody']['content']['application/json'];
export type WerewolfGameHistoryResponse = operations['werewolf___game-history']['responses']['200']['content']['application/json'];
export type WerewolfGamesRequest = operations['werewolf___games']['requestBody']['content']['application/json'];
export type WerewolfGamesResponse = operations['werewolf___games']['responses']['200']['content']['application/json'];
export type WerewolfGetVoiceCredsRequest = operations['werewolf___get-voice-creds']['requestBody']['content']['application/json'];
export type WerewolfGetVoiceCredsResponse = operations['werewolf___get-voice-creds']['responses']['200']['content']['application/json'];
export type WerewolfJoinRequest = operations['werewolf___join']['requestBody']['content']['application/json'];
export type WerewolfLeaveRequest = operations['werewolf___leave']['requestBody']['content']['application/json'];
export type WerewolfReadyRequest = operations['werewolf___ready']['requestBody']['content']['application/json'];
export type WerewolfSelfDestructRequest = operations['werewolf___self-destruct']['requestBody']['content']['application/json'];
export type WerewolfSendMessageRequest = operations['werewolf___send-message']['requestBody']['content']['application/json'];
export type WerewolfShowRequest = operations['werewolf___show']['requestBody']['content']['application/json'];
export type WerewolfShowResponse = operations['werewolf___show']['responses']['200']['content']['application/json'];
export type WerewolfSkipSpeechRequest = operations['werewolf___skip-speech']['requestBody']['content']['application/json'];
export type WerewolfTakeSeatRequest = operations['werewolf___take-seat']['requestBody']['content']['application/json'];
export type WerewolfUnreadyRequest = operations['werewolf___unready']['requestBody']['content']['application/json'];
export type WerewolfVoiceNegotiateRequest = operations['werewolf___voice-negotiate']['requestBody']['content']['application/json'];
export type WerewolfVoiceNegotiateResponse = operations['werewolf___voice-negotiate']['responses']['200']['content']['application/json'];
export type WerewolfVoicePullSingleTrackRequest = operations['werewolf___voice-pull-single-track']['requestBody']['content']['application/json'];
export type WerewolfVoicePullSingleTrackResponse = operations['werewolf___voice-pull-single-track']['responses']['200']['content']['application/json'];
export type WerewolfVoicePullTracksRequest = operations['werewolf___voice-pull-tracks']['requestBody']['content']['application/json'];
export type WerewolfVoicePullTracksResponse = operations['werewolf___voice-pull-tracks']['responses']['200']['content']['application/json'];
