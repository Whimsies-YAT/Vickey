...
export type GomokuGameLite = components['schemas']['GomokuGameLite'];
export type GomokuGameDetailed = components['schemas']['GomokuGameDetailed'];
export type WerewolfGameLite = components['schemas']['WerewolfGameLite'];
export type WerewolfGameDetailed = components['schemas']['WerewolfGameDetailed'];
