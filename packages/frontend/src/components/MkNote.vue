			...
			<div style="container-type: inline-size;">
				...
				<div v-show="appearNote.cw == null || showContent" :class="[{ [$style.contentCollapsed]: collapsed }]">
					...
					<MkPoll
						...
						:class="$style.poll"
					/>
					<MkNoteLocation :geojson="appearNote.geojson"/>
...
import MkNoteLocation from '@/components/MkNoteLocation.vue';
...
function onContextmenu(ev: PointerEvent): void {
	...
	if (prefer.s.useReactionPickerForContextMenu) {
		...
		const { menu, cleanup } = getNoteMenu({ note: note, translating, translation, convert, converting, currentClip: currentClip?.value, currentAntenna: currentAntenna?.value ?? undefined });
