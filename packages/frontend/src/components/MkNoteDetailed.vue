...
import { computed, inject, onMounted, provide, reactive, ref, useTemplateRef, watch, onUnmounted } from 'vue';
...
function onContextmenu(ev: MouseEvent): void {
	...
	if (prefer.s.useReactionPickerForContextMenu) {
		...
		const { menu, cleanup } = getNoteMenu({ note: note, translating, translation, converting, convert });
