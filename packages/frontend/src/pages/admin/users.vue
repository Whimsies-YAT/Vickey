...
<PageWithHeader :actions="headerActions" :tabs="headerTabs">
	<div class="_spacer" style="--MI_SPACER-w: 900px;">
		<div class="_gaps">
			...
			<MkPagination v-slot="{items}" :paginator="paginator" :displayLimit="50">
...
type SearchQuery = {
	...
	state?: 'all' | 'available' | 'approved' | 'admin' | 'moderator' | 'suspended';
...
const {
	...
	items: [
		...
		{ label: i18n.ts.notApproved, value: 'approved' },
