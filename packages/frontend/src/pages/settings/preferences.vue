							...
							<MkSelect v-model="lang" :items="langs.map(x => ({ label: x[1], value: x[0] }))">
								...
								<template #caption>
									<I18n :src="i18n.ts.i18nInfo" tag="span">
										<template #link>
											<MkLink url="https://crowdin.com/project/vickey">Vickey Crowdin</MkLink>/
											<MkLink url="https://crowdin.com/project/misskey">Misskey Crowdin</MkLink>
										</template>
									</I18n>
								</template>
							</MkSelect>
							...
							<MkPreferenceContainer k="serverDisconnectedBehavior">
								<MkSelect
									...
									:items="[
										...
										{ label: i18n.ts._serverDisconnectedBehavior.reload + ' (' + i18n.ts.deprecatedFunction + ')', value: 'dialog' },
										{ label: i18n.ts._serverDisconnectedBehavior.null, value: null },
								  ]"
								>
