		...
		<SearchMarker>
			<MkFolder>
				...
				<div class="_gaps_m">
					...
					<SearchMarker :keywords="['VI']">
						<MkSwitch v-model="profile.isVI">
							<template #label><SearchLabel>{{ i18n.ts.flagAsVI }}</SearchLabel></template>
							<template #caption>{{ i18n.ts.flagAsVIDescription }}</template>
						</MkSwitch>
					</SearchMarker>
				</div>
			</MkFolder>
