...
export interface Locale extends ILocale {
    ...
    /**
     * >>>>>>> b629189f2cdfbfe5c253ada3142e8ced6e8008f3
     */
    "2": string;
    "3": {
        /**
    ...
    /**
     * This is usually done automatically. If migration failed for some reason, you can run it manually. Current settings will be overwritten.
     */
    "migrateOldSettings_description": string;
    /**
     * Migrating settings. Please wait... (You can also migrate manually later from Settings > Other > Migrate old client settings.)
     */
    ...
    "_initialTutorial": {
        "_timeline": {
            /**
             * A smart timeline that aggregates posts from various sources.
             */
            "smart": string;
            /**
             * タイムラインのしくみ
